...
| Catalogue des compléments alimentaires (C4) | `web/src/app/api/praticien/complements/route.ts` (route-api) | Fiche complément : composition, cumuls, compatibilités. | WN_C4_ENABLED | — | non | — |
